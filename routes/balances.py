...
def group_balance(group_id):
    ...
    for participant in participants:
        ...
        balance_data[uid]["paid"] += (
            participant.amount_paid or 0
        )


        balance_data[uid]["share"] += (
    ...
    for uid in balance_data:
        ...
        balance_data[uid]["balance"] = round(
...
# ------------------------------------------------
    ...
    # pending_settlements = Settlement.query.filter_by(group_id=group_id,status="Pending").all()
    
    return render_template(

    "balances/group_balance.html",
