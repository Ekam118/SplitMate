...
# @settlements.route("/<int:settlement_id>/paid", methods=["POST"])
...
#   # only payer can mark paid
#     if settlement.payer_id != user_id:

#         flash("Only payer can mark this settlement as paid.","danger")
#         return redirect(url_for("settlements.settlement_home"))
...
#         flash(
#             "This settlement is already completed.",
#             "warning"
#         )

#         return redirect(
#             url_for(
#                 "settlements.settlement_home"
#             )
#         )
...
#     notification = Notification(
#     user_id=settlement.receiver_id,
#     message=f"{settlement.payer.fullname} completed a settlement of ₹{settlement.amount}")
